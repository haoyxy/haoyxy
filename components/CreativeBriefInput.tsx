  ...
  return (
    <div className="main-card w-full p-6 sm:p-8 rounded-xl flex flex-col items-center space-y-6">
      ...
      <textarea
        ...
        className="w-full h-72 p-4 bg-slate-900 border-2 border-slate-700 rounded-lg shadow-inner focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 resize-y disabled:bg-slate-800 text-slate-300 placeholder-slate-500"
        aria-label="创意简介输入框"
      />
